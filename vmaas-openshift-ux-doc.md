# VMaaS for OpenShift — UX alignment with CNV (v1)
...
*Interactive mockup: `vmaas-openshift-ux-mockup.html`*  
*Continued work: [v2 UX doc](vmaas-openshift-ux-doc-v2.md) · [v2 mockup](vmaas-openshift-ux-mockup-v2.html)*
...
| **Location** | “Your Virtual machine will be created in the following location” · path inside a read-only **input field** (**Project** {name} › **Folder** {name|—}) + edit · **Project*** dropdown · **Folder (optional)** searchable select (“Search folder”) |
