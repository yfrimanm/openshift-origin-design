...
|---|---|---|---|
| **Green** | **75% – 100%** | Safe level | Limits overcommit to improve cluster stability. Product default **97.5%** is in this range. |
| **Yellow** | **50% – 74.9%** | Use with caution | Balances memory efficiency with moderate overcommit risk. |
| **Red** | **25% – 49.9%** | High risk | Maximizes memory efficiency with high overcommit risk. |
